  ...
  return (
    <Container>
      ...
      <Registros>
        {lancamentos.length === 0 ? (
          ...
          lancamentos.map((item) => (
            <Lancamento key={item._id} tipo={item.tipo}>
              <div className="dia">{item.dia}</div>
              <div className="descricao" data-test="registry-name">
                {item.descricao}
              </div>
              <div className="valor" data-test="registry-amount">
      ...
      <Saldo saldo={saldo}>
        ...
        <span className="total" data-test="total-amount">
